...
| 16 | **Withdrawal-simulation page** (owner example 2026-09-08): IRS withdrawal sim — RMD schedule (age 73), account-bucket withdrawals, tax at filed rates, Q2 conversion Plans A/B interactive | **NEXT — riding #15** | Sources: `position_lot`/holdings per account, `tax_year_facts` rates, `dim_tax_bracket`, Q2 scripts (`.scratch/q2/roth_path.py`) |
